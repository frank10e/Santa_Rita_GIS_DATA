...
# Generate table plot
table_plot <- tableGrob(df_table, theme = ttheme_default(base_size = 3))

temp_file <- tempfile(fileext = ".png")
tmap_save(idw_plot, filename = temp_file)

# Read the saved plot into a grob
idw_grob <- rasterGrob(png::readPNG(temp_file))

# Combine the IDW grob and the table plot
grid.arrange(idw_grob, table_plot, ncol=2)
unlink(temp_file)
